 ...
 * builder.setTitle("提示");
 * builder.setViewStyle(MyDialog.VIEW_STYLE_TITLEBAR);
 * builder.setMessage("确定要删除此条通知吗？");
 * builder.setButton1("确定", new MyDialog.OnClickListener() {
 *
 * @Override public void onClick(Dialog dialog, int which) {
 * dialog.dismiss();
 * }
 * });
 * builder.setButton2("取消", new MyDialog.OnClickListener() {
 * @Override public void onClick(Dialog dialog, int which) {
 * dialog.dismiss();
 * }
 * });
...
public class MyDialog extends Dialog {
    ...
    protected MyDialog(Context context, boolean cancelableOnTouchOutside) {
        this(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int marginBorder = ViewUtil.dip2px(context, 30);
        params.width = ViewUtil.getScreenWidth(context) - marginBorder * 2;
    ...
    public static class Builder {
        ...
        public Builder(Context context, int theme) {
            dialog = new MyDialog(context, theme);
            this.context = context;
            initData();
        }
        ...
        private void initData() {
            this.button1TextColor = Color.parseColor("#282828");
            this.button2TextColor = Color.parseColor("#282828");
            this.button3TextColor = Color.parseColor("#282828");
        ...
        public MyDialog create() {
            ...
            switch (viewStyle) {
                case VIEW_STYLE_TITLEBAR:
                    mView = LayoutInflater.from(context).inflate(
                            R.layout.dialog_titlebar, null);
                    break;
                case VIEW_STYLE_TITLEBAR_SKYBLUE:
                    mView = LayoutInflater.from(context).inflate(
                            R.layout.dialog_titlebar_skyblue, null);
                    break;
            ...
            switch (btnCountFlag) {
                ...
                case 5:
                    ...
                    btnCenter
                            .setBackgroundResource(R.drawable.my_dialog_btn_single_selector);
                    if (button1Text != null) {
